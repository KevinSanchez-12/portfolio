...
function enviarCorreo(){
  ...
  if(nombre == "" || correo == "" || asunto == "" || mensaje == ""){
    ...
    document.getElementById("btn-mensaje").disabled = true;
    document.getElementById("btn-mensaje").innerHTML = "Enviando...";
    $.ajax({
      method : "POST",
      url: "https://formsubmit.co/ajax/kevinsanmaga12@gmail.com",
      ...
      function (data) {
        ...
        document.getElementById("btn-mensaje").innerHTML = "<i class='ri-send-plane-line'></i>Enviar mensaje";
